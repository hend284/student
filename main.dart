        ...
        Padding(
          ...
          child: Stack(
            children: <Widget>[
              CircleAvatar(
                radius: 70,
                child: ClipOval(child:Image.asset('images/girl.jpg'
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('Nationality Number     ', style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(' Mobile          +201098994284', style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
               Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('Birth place           Mansoura', style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
               Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('Nationality          Egyptian', style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
